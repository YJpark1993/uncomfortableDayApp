...
public class JoinActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    // UI references.
    private FancyButton mBtnRepeat;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBtnRepeat = (FancyButton) findViewById(R.id.ju);
        mBtnRepeat.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(JoinActivity.this, CheckRepeatActivity.class);
                String reEmail = mEmailView.getText().toString();
                i.putExtra("email", reEmail);
    ...
    private void attemptLogin() {
        ...
        if (TextUtils.isEmpty(password) && !isPasswordValid(password)) {
            ...
            mNameView.setError(getString(R.string.error_invalid_entry));
            focusView = mNameView;
            cancel = true;
        }else if (TextUtils.isEmpty(phone)) {
            mPhoneView.setError(getString(R.string.error_invalid_entry));
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected void onPostExecute(final Boolean success) {
            ...
            if (success) {
                Intent intent = new Intent(JoinActivity.this, SendToServerUserInfoActivity.class);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        Log.d("xxx", "onActivityResult Main : " + resultCode +" result : ");
        ...
        switch (resultCode) {
            case 1:  // 아이디가 중복인경우
                ...
                break;
            case 2:
                Intent toStartActivity = new Intent(JoinActivity.this, StartActivity.class);
                startActivity(toStartActivity);
                break;
            case 100:  // 중복 x
                TastyToast.makeText(getApplicationContext(),"사용가능한 이메일입니다.",TastyToast.LENGTH_SHORT,TastyToast.SUCCESS);
                mEmailView.requestFocus();
                break;
        }
    }
    ...
    protected void onStop() {
        Log.d("xxx", "onStop JoinActivity");
        super.onStop();
    }

    @Override
    protected void onDestroy() {
        Log.d("xxx", "onDestroy JoinActivity");
        super.onDestroy();
    }

    @Override
    protected void onPause() {
        Log.d("xxx", "onPause JoinActivity");
        super.onPause();
    }

...
public class uploadRoad extends AppCompatActivity {
    Intent from;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        from = getIntent();
        keyRoad = from.getStringExtra("keyRoad");
    ...
    private class SendPost extends AsyncTask<Void, Void, String> {
        ...
        public String executeClient() {
            ...
            post.add(new BasicNameValuePair("keyRoad", keyRoad));
            ...
            if (StartActivity.isLogin) {
                ...
                // Post객체 생성
                Log.i("xxx","isLogin");
                httpPost = new HttpPost("http://52.78.45.238/insert_Login_road.php");
                try {
                    isSuccess = true;
                ...
                // Post객체 생성
                Log.i("xxx","NoLogin");
                httpPost = new HttpPost("http://52.78.45.238/insert_noLogin_road.php");
                try {
                    isSuccess = true;
                    UrlEncodedFormEntity entity = new UrlEncodedFormEntity(post, "UTF-8");
                    httpPost.setEntity(entity);
